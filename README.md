...
| User AI session hours | 4.2h | 6.3h | 42.5h | 42.5h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 5.5h | 9.0h | 79.3h | 79.3h |
| Interactive sessions | 2 | 7 | 34 | 34 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 6,115 | 9K | 5.1M | 813.3M | $2,644.32 | $10,979.60 | $0.00 |
| gpt-5.5 | 83 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,198** | **295K** | **5.1M** | **817.8M** | **$2,646.45** | **$10,991.98** | **$9.74** |

_878.7M total tokens processed. 93.1% cache hit rate._

_$11,001.72 total saved ($10,991.98 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,430 | 10K | 5.9M | 986.8M | $3,140.74 | $13,321.94 | $0.00 |
...
| **Total** | **14,972** | **8.9M** | **10.4M** | **2,243.4M** | **$6,204.01** | **$28,425.23** | **$312.82** |

_2,387.1M total tokens processed. 94% cache hit rate._

_$28,738.05 total saved ($28,425.23 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-21 22:53 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
