...
| User AI session hours | 2.8h | 4.7h | 40.7h | 40.7h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 4.2h | 6.8h | 76.9h | 76.9h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 6,081 | 8K | 5.0M | 810.8M | $2,594.96 | $10,946.14 | $0.00 |
| gpt-5.5 | 83 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,164** | **295K** | **5.0M** | **815.4M** | **$2,597.09** | **$10,958.51** | **$9.74** |

_874.2M total tokens processed. 93.3% cache hit rate._

_$10,968.26 total saved ($10,958.51 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,396 | 10K | 5.8M | 984.3M | $3,091.38 | $13,288.48 | $0.00 |
...
| **Total** | **14,938** | **8.9M** | **10.2M** | **2,240.9M** | **$6,154.65** | **$28,391.76** | **$312.82** |

_2,382.5M total tokens processed. 94.1% cache hit rate._

_$28,704.59 total saved ($28,391.76 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-21 12:35 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
