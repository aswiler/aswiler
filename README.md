...
| User AI session hours | 0.1h | 12.4h | 84.3h | 120.5h |
| AI worker hours | 0.0h | 0.0h | 0.0h | 0.3h |
| AI concurrency hours | 0.5h | 18.3h | 145.3h | 215.6h |
| Interactive sessions | 5 | 14 | 65 | 93 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 3,918 | 7K | 2.9M | 625.8M | $1,967.11 | $8,449.51 | $0.00 |
...
| **Total** | **11,086** | **39.2M** | **6.9M** | **1,507.0M** | **$3,353.79** | **$13,960.31** | **$1,272.27** |

_1,623.1M total tokens processed. 92.8% cache hit rate._

_$15,232.58 total saved ($13,960.31 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **25,563** | **48.1M** | **16.8M** | **3,697.6M** | **$9,319.54** | **$41,672.68** | **$1,585.10** |

_3,950.5M total tokens processed. 93.6% cache hit rate._

_$43,257.78 total saved ($41,672.68 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-15 14:20 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
