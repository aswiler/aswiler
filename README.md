...
| User AI session hours | 1.7h | 10.6h | 37.9h | 37.9h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 2.3h | 18.9h | 72.7h | 72.7h |
| Interactive sessions | 2 | 13 | 30 | 30 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 5,768 | 8K | 4.7M | 775.5M | $2,461.47 | $10,469.95 | $0.00 |
| gpt-5.5 | 83 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **5,851** | **295K** | **4.7M** | **780.1M** | **$2,463.60** | **$10,482.32** | **$9.74** |

_835.4M total tokens processed. 93.4% cache hit rate._

_$10,492.06 total saved ($10,482.32 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,081 | 10K | 5.5M | 948.9M | $2,955.72 | $12,810.89 | $0.00 |
...
| **Total** | **14,623** | **8.9M** | **10.0M** | **2,205.5M** | **$6,018.99** | **$27,914.18** | **$312.82** |

_2,343.5M total tokens processed. 94.1% cache hit rate._

_$28,227.00 total saved ($27,914.18 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-19 10:58 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
