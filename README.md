...
| User AI session hours | 3.8h | 6.0h | 42.2h | 42.2h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 5.0h | 8.6h | 78.9h | 78.9h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 6,106 | 9K | 5.1M | 812.5M | $2,631.20 | $10,969.34 | $0.00 |
| gpt-5.5 | 83 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,189** | **295K** | **5.1M** | **817.1M** | **$2,633.33** | **$10,981.71** | **$9.74** |

_877.4M total tokens processed. 93.1% cache hit rate._

_$10,991.46 total saved ($10,981.71 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,421 | 10K | 5.9M | 986.0M | $3,127.62 | $13,311.68 | $0.00 |
...
| **Total** | **14,963** | **8.9M** | **10.3M** | **2,242.6M** | **$6,190.89** | **$28,414.96** | **$312.82** |

_2,385.7M total tokens processed. 94% cache hit rate._

_$28,727.79 total saved ($28,414.96 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-21 21:52 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
