...
| User AI session hours | 0.2h | 5.7h | 80.6h | 121.1h |
| AI worker hours | 0.0h | 0.3h | 13.4h | 49.8h |
| AI concurrency hours | 0.5h | 8.5h | 153.7h | 266.4h |
| Interactive sessions | 1 | 12 | 64 | 95 |
| Worker sessions | 0 | 6 | 134 | 3 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 4,057 | 8K | 3.0M | 644.2M | $2,033.27 | $8,697.70 | $0.00 |
...
| **Total** | **11,079** | **39.2M** | **6.9M** | **1,510.5M** | **$3,366.70** | **$14,006.70** | **$1,272.27** |

_1,627.0M total tokens processed. 92.8% cache hit rate._

_$15,278.98 total saved ($14,006.70 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **25,702** | **48.1M** | **16.9M** | **3,716.0M** | **$9,385.70** | **$41,920.88** | **$1,585.10** |

_3,970.6M total tokens processed. 93.6% cache hit rate._

_$43,505.98 total saved ($41,920.88 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-18 10:52 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
