...
| User AI session hours | 0.3h | 5.7h | 79.3h | 121.2h |
| AI worker hours | 0.9h | 1.2h | 14.3h | 50.7h |
| AI concurrency hours | 2.5h | 10.4h | 153.8h | 268.3h |
| Interactive sessions | 1 | 12 | 64 | 95 |
| Worker sessions | 2 | 8 | 136 | 3 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 4,204 | 8K | 3.1M | 671.6M | $2,112.92 | $9,067.18 | $0.00 |
...
| **Total** | **11,226** | **39.2M** | **6.9M** | **1,537.8M** | **$3,446.35** | **$14,376.18** | **$1,272.27** |

_1,656.5M total tokens processed. 92.9% cache hit rate._

_$15,648.45 total saved ($14,376.18 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **25,849** | **48.1M** | **17.0M** | **3,743.4M** | **$9,465.35** | **$42,290.35** | **$1,585.10** |

_4,000.1M total tokens processed. 93.6% cache hit rate._

_$43,875.45 total saved ($42,290.35 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-18 19:58 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
