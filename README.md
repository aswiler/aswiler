...
| User AI session hours | 1.6h | 8.1h | 46.0h | 46.0h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 3.0h | 13.2h | 85.9h | 85.9h |
| Interactive sessions | 3 | 9 | 38 | 38 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 6,462 | 9K | 5.5M | 849.1M | $2,824.39 | $11,463.56 | $0.00 |
| gpt-5.5 | 84 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,546** | **296K** | **5.5M** | **853.7M** | **$2,826.52** | **$11,475.93** | **$9.74** |

_920.0M total tokens processed. 92.8% cache hit rate._

_$11,485.67 total saved ($11,475.93 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,814 | 11K | 6.4M | 1,026.5M | $3,353.37 | $13,858.90 | $0.00 |
...
| **Total** | **15,357** | **8.9M** | **10.9M** | **2,283.1M** | **$6,416.64** | **$28,962.18** | **$312.82** |

_2,433.5M total tokens processed. 93.8% cache hit rate._

_$29,275.01 total saved ($28,962.18 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-26 12:40 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
