...
| User AI session hours | 0.4h | 2.3h | 38.3h | 38.3h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 1.1h | 3.7h | 73.8h | 73.8h |
| Interactive sessions | 3 | 7 | 33 | 33 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 5,949 | 8K | 4.8M | 796.0M | $2,523.22 | $10,747.11 | $0.00 |
| gpt-5.5 | 83 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,032** | **295K** | **4.9M** | **800.6M** | **$2,525.35** | **$10,759.48** | **$9.74** |

_857.1M total tokens processed. 93.4% cache hit rate._

_$10,769.23 total saved ($10,759.48 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,264 | 10K | 5.6M | 969.5M | $3,019.64 | $13,089.45 | $0.00 |
...
| **Total** | **14,806** | **8.9M** | **10.1M** | **2,226.1M** | **$6,082.91** | **$28,192.73** | **$312.82** |

_2,365.5M total tokens processed. 94.1% cache hit rate._

_$28,505.56 total saved ($28,192.73 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-21 05:11 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
