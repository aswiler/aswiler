...
| User AI session hours | 0.0h | 5.5h | 80.7h | 120.9h |
| AI worker hours | 0.0h | 0.3h | 13.4h | 49.8h |
| AI concurrency hours | 0.1h | 8.2h | 153.7h | 266.0h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 4,040 | 8K | 3.0M | 640.8M | $2,022.74 | $8,651.98 | $0.00 |
...
| **Total** | **11,062** | **39.2M** | **6.8M** | **1,507.1M** | **$3,356.17** | **$13,960.98** | **$1,272.27** |

_1,623.4M total tokens processed. 92.8% cache hit rate._

_$15,233.26 total saved ($13,960.98 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **25,685** | **48.1M** | **16.9M** | **3,712.6M** | **$9,375.17** | **$41,875.16** | **$1,585.10** |

_3,967.0M total tokens processed. 93.6% cache hit rate._

_$43,460.26 total saved ($41,875.16 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-18 09:49 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
