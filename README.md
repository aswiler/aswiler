...
| User AI session hours | 0.2h | 5.7h | 80.4h | 121.1h |
| AI worker hours | 0.0h | 0.3h | 13.4h | 49.8h |
| AI concurrency hours | 0.5h | 8.5h | 153.3h | 266.4h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 4,060 | 8K | 3.0M | 644.7M | $2,038.27 | $8,703.76 | $0.00 |
...
| **Total** | **11,082** | **39.2M** | **6.9M** | **1,510.9M** | **$3,371.70** | **$14,012.76** | **$1,272.27** |

_1,627.7M total tokens processed. 92.8% cache hit rate._

_$15,285.03 total saved ($14,012.76 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **25,705** | **48.1M** | **16.9M** | **3,716.5M** | **$9,390.70** | **$41,926.93** | **$1,585.10** |

_3,971.3M total tokens processed. 93.6% cache hit rate._

_$43,512.03 total saved ($41,926.93 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-18 13:08 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
