...
| User AI session hours | 0.6h | 5.4h | 79.0h | 121.4h |
| AI worker hours | 0.9h | 1.1h | 14.3h | 50.7h |
| AI concurrency hours | 3.3h | 10.5h | 153.9h | 269.1h |
| Interactive sessions | 3 | 11 | 65 | 96 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-8 | 4,374 | 8K | 3.2M | 708.3M | $2,200.06 | $9,562.40 | $0.00 |
...
| **Total** | **11,396** | **39.2M** | **7.0M** | **1,574.5M** | **$3,533.49** | **$14,871.40** | **$1,272.27** |

_1,694.3M total tokens processed. 92.9% cache hit rate._

_$16,143.67 total saved ($14,871.40 caching + $1,272.27 model routing vs all-Opus)._
...
| **Total** | **26,019** | **48.1M** | **17.1M** | **3,780.1M** | **$9,552.49** | **$42,785.57** | **$1,585.10** |

_4,037.9M total tokens processed. 93.6% cache hit rate._

_$44,370.67 total saved ($42,785.57 caching + $1,585.10 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-18 22:59 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
