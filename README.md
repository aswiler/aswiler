...
| User AI session hours | 2.6h | 9.1h | 47.0h | 47.0h |
| AI worker hours | 0.0h | 0.0h | 0.3h | 0.3h |
| AI concurrency hours | 5.2h | 15.5h | 88.2h | 88.2h |
| Interactive sessions | 5 | 10 | 39 | 39 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 6,554 | 9K | 5.7M | 857.0M | $2,882.07 | $11,569.87 | $0.00 |
| gpt-5.5 | 84 | 286K | 13K | 4.5M | $2.13 | $12.37 | $9.74 |
| **Total** | **6,638** | **296K** | **5.7M** | **861.6M** | **$2,884.20** | **$11,582.25** | **$9.74** |

_929.7M total tokens processed. 92.7% cache hit rate._

_$11,591.99 total saved ($11,582.25 caching + $9.74 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 7,906 | 11K | 6.6M | 1,034.4M | $3,411.05 | $13,965.21 | $0.00 |
...
| **Total** | **15,449** | **8.9M** | **11.1M** | **2,291.0M** | **$6,474.32** | **$29,068.50** | **$312.82** |

_2,443.2M total tokens processed. 93.8% cache hit rate._

_$29,381.33 total saved ($29,068.50 caching + $312.82 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-05-26 13:40 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
